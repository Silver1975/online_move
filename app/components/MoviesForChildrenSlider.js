              ...
              <div key={movie.id} className={styles.box}>
                ...
                <div className={styles.hoverCard}>
                  ...
                  <div className={styles.flexElements}>
                    <div style={{color:"#c0c0c0", fontSize:"14",fontFamily:"'Quicksand', sans-serif", margin:"0 1px 0 12px"}} >{movie.tags?.join(", ")}</div>
                    <div style={{color:"#c0c0c0", fontSize:"14",fontFamily:"'Quicksand', sans-serif",margin:"0 1px 0 0"}}>{movie.firstAirDate?.split("-")[0]}</div>
                    <div style={{color:"#c0c0c0", fontSize:"14",fontFamily:"'Quicksand', sans-serif",margin:"0 1px 0 0"}}>{movie.amountOfEpisodes} s-ns</div>
